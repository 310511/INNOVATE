...
const Signup: React.FC = () => {
 ...
 const renderStep1 = () => (
    ...
    <form className="space-y-5">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 text-gray-800 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all"
          required
        />
      </div>
      ...
      <button
        ...
        onClick={sendOtp}
        disabled={isLoading}
        className="w-full bg-blue-600 hover:bg-blue-700 transition-all font-semibold text-white py-3 rounded-xl shadow-md disabled:bg-gray-400"
      >
  ...
  return (
    ...
    {/* LEFT SIDE */}
    <div
      className="hidden lg:flex w-1/2 items-center justify-center text-white relative"
      style={{
    ...
    {/* RIGHT SIDE */}
    <div className="w-full lg:w-1/2 flex items-start justify-center px-10 py-16 overflow-y-auto">
